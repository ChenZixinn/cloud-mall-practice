...
import com.imooc.cloud.mall.practice.commom.util.OrderCodeFactory;
import com.imooc.cloud.mall.practice.commom.util.QRCodeGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String create(CreateOrderReq createOrderReq) {
        ...
        for (OrderItem cartVO : orderItemList) {
            ...
            productFeignClient.updateStockForFeign(productId, product.getStock());
        }
        ...
        order.setUserId(userFeignClient.getUser().getId());
...
//            totalPrice += cartVO.getTotalPrice();
    ...
    public PageInfo listForCustomer(Integer pageNum, Integer pageSize) {
        ...
        List<Order> orderList = orderMapper.selectByUserId(userFeignClient.getUser().getId());
    ...
    public String qrcode(String orderNo) {
        ...
        String path = FILE_UPLOAD_DIR + orderNo + ".png";
        String content = address + "/cart-order/pay?orderNo=" + orderNo;
        String imgPath = address + "/cart-order/images/" + orderNo + ".png";
    ...
    public Order getOrderByOrderNo(String orderNo){
        ...
        // 判断订单是否属于用户
        if (!oldOrder.getUserId().equals(userFeignClient.getUser().getId())) {
            User user = userFeignClient.getUser();
            if(!(userFeignClient.getUser().getRole() == 2))
